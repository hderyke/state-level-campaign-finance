...
Each zip is saved as-is (still zipped) to data/Pennsylvania/{year}.zip —
...
def run(years: list[int] | None = None, start_year: int | None = None,
    ...
    log.info(f"Done in {duration}s — {downloaded} downloaded, "
             f"{skipped} skipped, {failed} failed. Files in {DATA_DIR}/")
...
if __name__ == "__main__":
    ...
    ap.add_argument("--out-dir", type=str, default=None,
                    help="directory for zips + manifest (default: data/Pennsylvania/)")
