...
| South Carolina (SC) | ✅ | ✅ | Utilized `ethicsfiling.sc.gov` to gather contribution, expenditure, and financial report. Additional party, office, and jurisdiction information was extracted from `electionhistory.scvotes.gov` |
